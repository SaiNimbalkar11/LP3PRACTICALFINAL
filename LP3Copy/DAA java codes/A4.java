...
class A4{
    ...
    public static void main(String args[]) {
        ...
        System.out.println("\n--- Complexity Analysis ---");
        System.out.println("Time Complexity  : O(N * W)  Reason: There are N*W states therefore at max ‘N*W’ new problems will be solved.");
        System.out.println("Space Complexity : O(N * W) for memoization table Reason: We are using a recursion stack space(O(N)) and a 2D array ( O(N*W)).");
    }
}